...
public class BeatBoxFinal {  // implements MetaEventListener 
      ...
      public static void main (String[] args) {
    	  if (args.length != 0) {
  			new BeatBoxFinal().startUp(args[0], args[1]);  //args[0] is your username
  		}
  		else {
  			System.out.println("Proper usage is: java BeatBox username server_IP_address");
  		}
      }
      
      public void startUp(String name, String serverAddress) {
          userName = name;
          try {
              Socket sock = new Socket(serverAddress, 4242);
